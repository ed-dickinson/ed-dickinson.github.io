...
window.Typekit.config = {
    "a": "646866",
    "dl": "AAAAVwAAAArV3u6xZk6yZABoICM",
    "fi": [5474, 175, 173, 139, 13456, 10954, 13458, 13454, 13457, 13453, 13459, 13455],
    "fc": [{
        "id": 5474,
        "family": "proxima-nova",
        "src": "https://use.typekit.net/af/1be3c2/00000000000000007735e606/30/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "300",
            "style": "normal",
            "display": "auto",
        ...
        "id": 175,
        "family": "proxima-nova",
        "src": "https://use.typekit.net/af/efe4a5/00000000000000007735e609/30/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "display": "auto",
        ...
        "id": 173,
        "family": "proxima-nova",
        "src": "https://use.typekit.net/af/78aca8/00000000000000007735e60d/30/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "600",
            "style": "normal",
            "display": "auto",
        ...
        "id": 139,
        "family": "proxima-nova",
        "src": "https://use.typekit.net/af/2555e1/00000000000000007735e603/30/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "700",
            "style": "normal",
            "display": "auto",
        ...
        "src": "https://use.typekit.net/af/ba2099/000000000000000000010b58/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "300",
            "style": "normal",
            "display": "auto",
        ...
        "id": 10954,
        "family": "freight-sans-pro",
        "src": "https://use.typekit.net/af/442215/000000000000000000010b5a/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "display": "auto",
        ...
        "id": 13458,
        "family": "freight-sans-pro",
        "src": "https://use.typekit.net/af/8dd886/000000000000000000010b5c/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "500",
            "style": "normal",
            "display": "auto",
        ...
        "id": 13454,
        "family": "freight-sans-pro",
        "src": "https://use.typekit.net/af/1709eb/000000000000000000010b60/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "700",
            "style": "normal",
            "display": "auto",
        ...
        "id": 13457,
        "family": "freight-sans-pro",
        "src": "https://use.typekit.net/af/1ece10/000000000000000000010b59/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "300",
            "style": "italic",
            "display": "auto",
        ...
        "id": 13453,
        "family": "freight-sans-pro",
        "src": "https://use.typekit.net/af/3df5fe/000000000000000000010b5b/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "italic",
            "display": "auto",
        ...
        "id": 13459,
        "family": "freight-sans-pro",
        "src": "https://use.typekit.net/af/441f33/000000000000000000010b5d/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "500",
            "style": "italic",
            "display": "auto",
        ...
        "id": 13455,
        "family": "freight-sans-pro",
        "src": "https://use.typekit.net/af/65fc7d/000000000000000000010b61/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "700",
            "style": "italic",
            "display": "auto",
    ...
    "fn": ["freight-sans-pro", ["i3", "i4", "i5", "i7", "n3", "n4", "n5", "n7"], "proxima-nova", ["n3", "n4", "n6", "n7"]],
    "hn": "use.typekit.net",
    "ht": "tk",
    "js": "1.20.0",
    "kt": "646866_52a9a089e4b0b53da92fe3cb",
    "l": "typekit",
    "ps": 2,
...
/*{"k":"1.20.0","auto_updating":true,"last_published":"2018-04-04 19:48:00 UTC"}*/
;(function(window, document, undefined) {
    ...
    function ya(a) {
        ...
        (d = b === a.g.serif && c === a.g["sans-serif"]) || (d = xa() && za(a, b, c));
        d ? l() - a.F >= a.I ? xa() && za(a, b, c) && (!a.A || a.A.hasOwnProperty(a.b.b)) ? Q(a, a.D) : Q(a, a.H) : Aa(a) : Q(a, a.D)
    }
    function Aa(a) {
            ...
            J(b, function(b) {
                ...
                if (null === S)
                    if (window.FontFace) {
                        ...
                        S = e ? 42 < parseInt(e[1], 10) : na && /Apple/.exec(window.navigator.vendor) ? 603 <= parseInt(na[1], 10) : !0
                    } else
                        S = !1;
                S ? c = new Ba(h(a.i, a),h(a.j, a),a.w,b,a.A,"BESbswy\ue000\ue001\ue002\ue003\ue004\ue005\ue006",a.u) : c = new wa(h(a.i, a),h(a.j, a),a.w,b,a.A,d,"BESbswy\ue000\ue001\ue002\ue003\ue004\ue005\ue006",a.u);
                f.push(c)
            });
    ...
    function Da(a) {
        !--a.g && a.m && (a.o ? (a = a.b,
        a.i && y(a.g, [a.b.b("wf", "active")], [a.b.b("wf", "loading"), a.b.b("wf", "inactive")]),
        C(a, "active")) : B(a.b))
    }
    ;function T(a) {
        this.b = a;
        ...
        c = new A(this.b,c,{
            active: function() {
                ...
                if (d.m) {
                    ...
                    w = window.Typekit.fonts) : window.TypekitPreview && (window.TypekitPreview.fonts || (window.TypekitPreview.fonts = []),
    ...
    if (!window.Typekit.load) {
        var U = new Ha(new G("//" + (window.Typekit.config || {}).hn + "/{id}.js"),Ma);
    ...
    for (var V, m = window.Typekit.config || {}, La = [], Na = m.fc, Oa = 0; Oa < Na.length; Oa++)
        La.push(Na[Oa].id);
    V = new T(Ma);
    m.ping && (V.m = new Ka);
    m.vft && (V.o = m.vft);
    if (m.fc)
        for (var W = m.fc, X = 0; X < W.length; X++) {
            var Y = W[X].src, Pa = W[X].descriptors || {}, Qa;
            if (Qa = V.o)
                null === Ea && (Ea = window.CSS && window.CSS.supports && CSS.supports("font-variation-settings", '"wght" 400')),
                Qa = Ea;
